...
public class DiceGame
{
	...
	private ArrayList<ScoringCategory> scoreCat = new ArrayList<>();
  ...
  {
	  Hand returnHand = new Hand(diceCount, maxValue, countRolls);
	  return returnHand;
  }
  ...
  public int getScore()
  {
	  int totalScore = 0;
	  int handScore = 0;
	  for (int i = 0; i < scoreCat.size(); i++)
	  {
		  handScore = scoreCat.get(i).getScore();
